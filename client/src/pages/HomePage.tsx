            ...
            <div className="terminal-box rounded-lg p-4 sm:p-6 font-mono text-sm">
              <div className="space-y-3">
                {recentActivity.map((activity, index) => (
                  ...
                  >
                    <span className="text-yellow-500/80 flex-shrink-0">
                      {activity.hash}
                    </span>
                    <span className="text-terminal flex-shrink-0">
                      @{activity.user}
                    </span>
            ...
            <div className="terminal-box rounded-lg overflow-hidden">
              ...
              <div className="p-6 sm:p-8">
                ...
                <p className="text-text-secondary mb-6 text-lg">
                  Join thousands of developers already building connections and
                  sharing knowledge.
                </p>
